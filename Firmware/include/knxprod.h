...
#define ADR_stairtime		0x0001
#define ADR_stairtime_Shift	5
#define ADR_stairtime_Mask	0x07FF
// Offset: 1, Size: 11 Bit, Text: Nachlaufzeit
#define ParamADR_stairtimeIndex(X) ((uint)((knx.paramWord((ADR_ParamBlockOffset + ADR_ParamBlockSize * X + 1)) >> ADR_stairtime_Shift) & ADR_stairtime_Mask))
// Offset: 1, Size: 11 Bit, Text: Nachlaufzeit
#define ParamADR_stairtime ((uint)((knx.paramWord((ADR_ParamBlockOffset + ADR_ParamBlockSize * channelIndex() + 1)) >> ADR_stairtime_Shift) & ADR_stairtime_Mask))
...
#define ADR_lockbehave		0x0003
#define ADR_lockbehave_Shift	6
#define ADR_lockbehave_Mask	0x0003
// Offset: 3, Size: 2 Bit, Text: Verhalten bei Sperren
#define ParamADR_lockbehaveIndex(X) ((uint)((knx.paramByte((ADR_ParamBlockOffset + ADR_ParamBlockSize * X + 3)) >> ADR_lockbehave_Shift) & ADR_lockbehave_Mask))
// Offset: 3, Size: 2 Bit, Text: Verhalten bei Sperren
#define ParamADR_lockbehave ((uint)((knx.paramByte((ADR_ParamBlockOffset + ADR_ParamBlockSize * channelIndex() + 3)) >> ADR_lockbehave_Shift) & ADR_lockbehave_Mask))
#define ADR_unlockbehave		0x0003
#define ADR_unlockbehave_Shift	4
#define ADR_unlockbehave_Mask	0x0003
// Offset: 3, BitOffset: 2, Size: 2 Bit, Text: Verhalten bei Entsperren
#define ParamADR_unlockbehaveIndex(X) ((uint)((knx.paramByte((ADR_ParamBlockOffset + ADR_ParamBlockSize * X + 3)) >> ADR_unlockbehave_Shift) & ADR_unlockbehave_Mask))
// Offset: 3, BitOffset: 2, Size: 2 Bit, Text: Verhalten bei Entsperren
#define ParamADR_unlockbehave ((uint)((knx.paramByte((ADR_ParamBlockOffset + ADR_ParamBlockSize * channelIndex() + 3)) >> ADR_unlockbehave_Shift) & ADR_unlockbehave_Mask))
